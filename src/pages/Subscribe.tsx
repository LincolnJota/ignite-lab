...
export function Subscribe() {
  ...
  async function HandlerSubscribe(event: FormEvent) {
    ...
    <div className="min-h-screen bg-blur bg-cover bg-no-repeat flex flex-col items-center">
      ...
      <div className="w-full max-w-[1100px] flex items-center justify-between mt-20 mx-auto">
        ...
        <div className="p-8 bg-gray-700 border border-gray-500 rounded">
          ...
          <form onSubmit={HandlerSubscribe} className="flex flex-col gap-2 w-full" >
            ...
            <button
              disabled={loading}
              className="disabled:opacity-50 mt-4 bg-green-500 uppercase py-4 rounded font-bold text-sm hover:bg-green-700 transition-colors"
              type="submit"
            >
              Garantir minha vaga
            </button>
      ...
      <img src="/src/assets/post-ground.png" className="mt-10" alt="" />
